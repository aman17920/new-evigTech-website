        ...
        var M = e.frame = function() {
          ...
          , B = l($, function(t, e) {
            t.init = function(t) {
                ...
                t.values)
                    n = t.values[e],
                    this.current[e] !== n && this.tweens.push(new $({
                        name: e,
                        from: this.current[e],
                        to: n,
                        duration: t.duration,
 ...
 */
    t.exports = function() {
        ...
        var p = t.some = t.any = function(n, i, r) {
            i || (i = t.identity);
            var o = !1;
            return null == n ? o : d && n.some === d ? n.some(i, r) : (v(n, function(t, n, a) {
                    ...
                    window.setTimeout(function() {
                        !function(e, n) {
                            ...
                            var a = function(t, e, n) {
                                if ("none" === document.body.getAttribute("data-wf-scroll-motion") || p.matches)
                                    return 0;
                                var i = 1;
...
, function(t, e, n) {
    ...
    i.define("navbar", t.exports = function(t, e) {
        var n, a, s, u, c = {}, l = t.tram, d = t(window), f = t(document), h = e.debounce, v = i.env(), p = '<div class="w-nav-overlay" data-wf-ignore />', m = ".w-nav", w = "w--open", g = "w--nav-dropdown-open", b = "w--nav-dropdown-toggle-open", y = "w--nav-dropdown-list-open", x = "w--nav-link-open", k = r.triggers, _ = t();
        function E() {
            i.resize.off(O)
        }
        function O() {
...
, function(t, e, n) {
    ...
    i.define("slider", t.exports = function(t, e) {
        var n, s, u, c, l = {}, d = t.tram, f = t(document), h = i.env(), v = ".w-slider", p = '<div class="w-slider-dot" data-wf-ignore />', m = '<div aria-live="off" aria-atomic="true" class="w-slider-aria-label" data-wf-ignore />', w = "w-slider-force-show", g = r.triggers;
        function b() {
            (n = f.find(v)).length && (n.each(k),
            c = null,
            u || (y(),
            i.resize.on(x),
        ...
        function k(e, n) {
            ...
            r.nav.off(v),
            _(r),
            s ? (r.el.on("setting" + v, S(r)),
            C(r),
            r.hasTimer = !1) : (r.el.on("swipe" + v, S(r)),
            r.left.on("click" + v, T(r)),
            r.right.on("click" + v, L(r)),
            r.left.on("keydown" + v, A(r, T)),
            r.right.on("keydown" + v, A(r, L)),
            r.nav.on("keydown" + v, "> div", S(r)),
            r.config.autoplay && !r.hasTimer && (r.hasTimer = !0,
            r.timerCount = 1,
            R(r)),
            r.el.on("mouseenter" + v, O(r, !0, "mouse")),
            r.el.on("focusin" + v, O(r, !0, "keyboard")),
            r.el.on("mouseleave" + v, O(r, !1, "mouse")),
            r.el.on("focusout" + v, O(r, !1, "keyboard"))),
            r.nav.on("click" + v, "> div", S(r)),
        ...
        function _(t) {
            ...
            E(t.el.attr("data-hide-arrows")) ? e.hideArrows = !0 : t.config.hideArrows && (t.left.show(),
            t.right.show()),
            E(t.el.attr("data-autoplay"))) {
                ...
                var i = "mousedown" + v + " touchstart" + v;
